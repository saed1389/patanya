                ...
                <div class="col-md-12 mt-4">
                    @if($adsHome[16]->type == 17 && $adsHome[16]->status == 1)
                        <a href="{{ $adsHome[16]->link }}" target="_blank">
                            <div style="background-color: #f59a9a; height: 224px; background-image: url({{ asset($adsHome[16]->ads) }}); background-repeat: round;  background-size: cover;">
                            </div>
                        </a>
                    @endif
                    @if($adsHome[19]->type == 20 && $adsHome[19]->status == 1)
                        <a href="{{ $adsHome[19]->link }}" target="_blank">
                            <div style="background-color: #f59a9a; height: 224px; margin-top: 5px; background-image: url({{ asset($adsHome[19]->ads) }}); background-repeat: round;  background-size: cover;">
                            </div>
                        </a>
                    @endif
                    @if($adsHome[20]->type == 21 && $adsHome[20]->status == 1)
                        <a href="{{ $adsHome[20]->link }}" target="_blank">
                            <div style="background-color: #f59a9a; height: 224px; background-image: url({{ asset($adsHome[20]->ads) }}); background-repeat: round;  background-size: cover;">
                            </div>
                        </a>
                    @endif
                </div>
